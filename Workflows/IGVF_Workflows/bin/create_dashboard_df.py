...
def create_dashboard_df(guide_fq_tbl, mudata_path, gene_ann_path, filtered_ann_path, guide_ann_path):
    ...
    gs_highlight=f"Number of Guide barcodes with a positive sgRNA call: {number_of_guide_barcodes_with_positive_call}, The median of cells with a positive sgRNA call is: {median_frequency}"
...
def main():
    ...
    all_df = pd.concat([guide_check_df, cell_stats, gene_stats, json_df_sorted, gs_img_df, rna_img_df, guide_img_df, inf_img_df, gi_df])
