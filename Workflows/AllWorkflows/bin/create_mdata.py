...
def main(adata_rna, adata_guide, guide_metadata, gtf):
    # Load the data
    ...
    adata_rna.var = adata_rna.var.join(df_gtf_unique_gene_name[['chr', 'start', 'end']].rename(columns={'chr': 'gene_chr', 
                                                                                                        'start': 'gene_start', 
                                                                                                        'end': 'gene_end'}))
...
if __name__ == "__main__":
    ...
    main(args.adata_rna, args.adata_guide, args.guide_metadata, args.gtf)
